...
export const GetMenteeTimeslot = getApi('mentee/request-class');
...
export const GetMenteeAllPending = getApi('mentee/get-all-pending-class');
export const GetMenteeAllApprove = getApi('mentee/get-all-approve-class');
...
export const MentorSubscriptionUrl = getApi('mentor/get-plan');
...
export const MenteeCheckoutUrl = getApi('mentee/checkout');
